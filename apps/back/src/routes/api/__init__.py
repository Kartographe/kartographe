...
from src.routes.api.bounded_contexts import router as bounded_contexts_router
...
v1_router.include_router(bounded_contexts_router)  # account-wide bounded-context listing
