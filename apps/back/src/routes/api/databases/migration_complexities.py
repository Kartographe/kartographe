...
List and give complexity estimates on a database migration. Any account member may read and estimate.
"""
...
router = APIRouter(prefix="/accounts/{account_id}/databases/{database_id}/migrations/{database_migration_id}/complexities", tags=["api.databases.migrations.complexities"])
...
@router.get(
    "",
    operation_id="api_databases_migrations_complexities_list",
    summary="List migration complexity estimates",
...
def list_migration_complexities(
...
@router.post(
    "",
    operation_id="api_databases_migrations_complexities_create",
    summary="Estimate the complexity of a migration",
    description=(
        "Give or update your complexity estimate on a database migration. Any member may estimate; "
...
def create_migration_complexity(
...
@router.delete(
    "",
    operation_id="api_databases_migrations_complexities_delete",
    summary="Withdraw your estimate on a migration",
    description=(
        "Withdraw your complexity estimate on a migration. Estimating `null` says \"I cannot "
...
def delete_migration_complexity(
    account: CurrentAccountDep,
    member: CurrentAccountUserDep,
    migration: CurrentDatabaseMigrationDep,
    manager: ComplexityManagerDep,
    ...
    manager.remove(
        account, member, entity_type=EntityType.DATABASE_MIGRATION, entity_id=migration.id
    )
