...
@router.delete(
    "",
    operation_id="api_databases_versions_tables_columns_complexities_delete",
    summary="Withdraw your estimate on a column",
    description=(
        "Withdraw your complexity estimate on a column. Estimating `null` says \"I cannot "
...
def delete_column_complexity(
    ...
    manager.remove(
        account, member, entity_type=EntityType.DATABASE_TABLE_COLUMN, entity_id=column.id
    )
