...
@router.post(
    "/bulk",
    operation_id="api_databases_versions_tables_columns_comments_bulk_create",
    summary="Post several comments on a column at once",
    description=(
        "Post 1 to 50 comments on a database column in a single call — prefer this over calling "
        "`api_databases_versions_tables_columns_comments_create` in a loop. Best-effort: each "
...
def bulk_create_column_comments(
