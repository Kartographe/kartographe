...
@router.post(
    "/bulk",
    operation_id="api_features_comments_bulk_create",
    summary="Post several comments on a feature at once",
    description=(
        "Post 1 to 50 comments on a feature in a single call — prefer this over calling "
        "`api_features_comments_create` in a loop. Best-effort: each comment is posted "
...
def bulk_create_feature_comments(
