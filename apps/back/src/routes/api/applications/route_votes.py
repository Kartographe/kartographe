...
List and cast votes on a application route. Any account member may read and vote.
"""
...
router = APIRouter(prefix="/accounts/{account_id}/applications/{application_id}/routes/{route_id}/votes", tags=["api.applications.routes.votes"])
...
@router.get(
    "",
    operation_id="api_applications_routes_votes_list",
    summary="List route votes",
...
@router.post(
    "",
    operation_id="api_applications_routes_votes_create",
    summary="Vote on a route",
    description=(
        "Cast or update your vote on a application route. Any member may vote; a member holds "
