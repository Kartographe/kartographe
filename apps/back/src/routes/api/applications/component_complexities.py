...
List and give complexity estimates on an application component. Any account member may read and estimate.
"""
...
router = APIRouter(prefix="/accounts/{account_id}/applications/{application_id}/components/{component_id}/complexities", tags=["api.applications.components.complexities"])
...
@router.get(
    "",
    operation_id="api_applications_components_complexities_list",
    summary="List component complexity estimates",
...
def list_component_complexities(
...
@router.post(
    "",
    operation_id="api_applications_components_complexities_create",
    summary="Estimate the complexity of a component",
    description=(
        "Give or update your complexity estimate on an application component. Any member may estimate; "
...
def create_component_complexity(
...
@router.delete(
    "",
    operation_id="api_applications_components_complexities_delete",
    summary="Withdraw your estimate on a component",
    description=(
        "Withdraw your complexity estimate on a component. Estimating `null` says \"I cannot "
...
def delete_component_complexity(
    account: CurrentAccountDep,
    member: CurrentAccountUserDep,
    component: CurrentApplicationComponentDep,
    manager: ComplexityManagerDep,
    ...
    manager.remove(
        account, member, entity_type=EntityType.APPLICATION_COMPONENT, entity_id=component.id
    )
