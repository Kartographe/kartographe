...
List and give complexity estimates on a service action. Any account member may read and estimate.
"""
...
router = APIRouter(prefix="/accounts/{account_id}/services/{service_id}/actions/{action_id}/complexities", tags=["api.services.actions.complexities"])
...
@router.get(
    "",
    operation_id="api_services_actions_complexities_list",
    summary="List service action complexity estimates",
...
@router.post(
    "",
    operation_id="api_services_actions_complexities_create",
    summary="Estimate the complexity of a service action",
    description=(
        "Give or update your complexity estimate on a service action. Any member may estimate; "
...
@router.delete(
    "",
    operation_id="api_services_actions_complexities_delete",
    summary="Withdraw your estimate on a service action",
    description=(
        "Withdraw your complexity estimate on a service action. Estimating `null` says \"I cannot "
...
def delete_action_complexity(
    ...
    manager.remove(
        account, member, entity_type=EntityType.SERVICE_ACTION, entity_id=action.id
    )
