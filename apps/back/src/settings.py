...
class Settings(BaseSettings):
    ...
    oauth_device_polling_interval_seconds: int = Field(default=5)
    oauth_authorization_code_ttl_seconds: int = Field(default=600)  # 10 min
    oauth_access_token_ttl_seconds: int = Field(default=3600)  # 1 h
    oauth_refresh_token_ttl_seconds: int = Field(default=2592000)  # 30 days
